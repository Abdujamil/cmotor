...
// Реактивная функция для фильтрации городов по региону
const filteredCities = computed(() => {
  if (selectedRegion.value) {
    return Object.keys(managersData).filter(city => city === selectedRegion.value);
  } else {
    return Object.keys(managersData);
  }
});
